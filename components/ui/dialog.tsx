...
function DialogContent({
  ...
  // When false, the overlay + content appear/disappear with no enter/exit
  // animation. The lightbox modals set this so the real Dialog drops in exactly
  // where its loading skeleton was, instead of re-fading/zooming over it.
  animate = true,
  ...props
