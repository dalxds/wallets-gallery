...
// Public data route: a capture's derived view, served byte-identical to the
// generated view.json. Canonical at the DATED URL (mirrors the gallery); the
// un-dated /apps/[slug]/view.json 307s here for the latest. Prerendered per known
...
export async function GET(
  ...
  const body = readCaptureFile(slug, date, "view.json")
