...
// /apps/[slug]/graph.json has no canonical content of its own — every capture's
// graph is canonical at its DATED URL. This 307s to the latest dated graph,
...
export async function GET(
  ...
  return new Response(null, {
    status: 307,
    headers: { location: `/apps/${slug}/${app.latest}/graph.json` },
  })
}
